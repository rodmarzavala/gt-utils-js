...
const userInputDpi = '1736893020101';
...
**Ejemplos:**
```typescript
// DPI matemáticamente válido (Dígito verificador: 2)
console.log(isValidCui('1736893020101')); // true

// DPI inválido por mal dígito verificador (8 en lugar de 2)
console.log(isValidCui('1736893080101')); // false

// DPI inválido por departamento que no existe (ej. 23)
console.log(isValidCui('1736893022301')); // false
```
...
```typescript
const info = getCuiInformation('1736893020101');
console.log(info);
/*
{
  isValid: true,
