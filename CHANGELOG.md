...
### Security
- Removed hardcoded sensitive identifying information (NIT/CUI) from all documentation examples and replaced them with generic mock data to prevent personal data leakage.
